...
class BidirectionNet:
    ...
    def train_multidataset(self, sess, maxEpoch=300, lr=0.0001,is_load=False,ckpt_path='',only_image = False):
        logdir = './log/Bidirectionnet_GMM/GMM_ourword2vec/new_topK/'
        print 'log in %s' %logdir
        model_save_path = './model/Bidirectionnet_GMM/GMM_ourword2vec/new_topK/'
        make_if_not_exist(model_save_path)
        model_save_path += 'model'
        data_root = '/media/ltp/40BC89ECBC89DD32/souhu_fusai/'
...
if __name__ == '__main__':
    ...
    with tf.Session(config=config) as sess:
        if is_train:
            ...
            model_path = './model/Bidirectionnet_GMM/GMM_ourword2vec/new_topK/model-15000'
            scope ='sentence'
            #scope='image'
           
            #save_path ='./emb/train_image_embed_GMM_ourword2vec_new_topK_15000.h5'
            save_path = './emb/train_sentence_embed_GMM_ourword2vec_new_topK_15000.h5'
